<template>
  <Transition name="page">
    <div v-if="modelValueInner" class="fixed top-0 left-0 w-full h-full">
      ...
      <div
        class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] max-h-[300px] bg-black shadow-step border-blue border rounded-[5px] z-20"
      >
